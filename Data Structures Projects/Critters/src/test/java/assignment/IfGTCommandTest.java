...
public class IfGTCommandTest extends TestCase {

    public void testExecuteCommand() {
        testCommand(2, 0, "100", 100);
        testCommand(10, 2, "r10", 10);
        testCommand(3, -98172, "+10", 15);
        testCommand(983, 2, "-10", -5);
        testCommand(1, 5, "-30298", 6);
        testCommand(-92873, -9873, "r10", 6);
        testCommand(-76, 1, "+10", 6);
        testCommand(37263, 888888, "-1", 6);
        testCommand(1, 1, "3872", 6);
        testCommand(2189, -9372, "4", 4);
    ...
    public void testCommand(int a, int b, String n, int nextLine) {
        Command command = new IfGTCommand();
