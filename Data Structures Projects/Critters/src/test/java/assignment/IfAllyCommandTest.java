...
public class IfAllyCommandTest extends TestCase {
    ...
    public void testExecuteCommand() {
        ...
        testCommand(Critter.ALLY, "123", 123);
        testCommand(Critter.ALLY, "r10", 10);
        testCommand(Critter.ALLY, "+10", 15);
        testCommand(Critter.ALLY, "-10", -5);
    ...
    public void testCommand(int a, String n, int nextLine) {
        Command command = new IfAllyCommand();
