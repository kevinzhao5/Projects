...
public class IfWallCommandTest extends TestCase {

    public void testExecuteCommand() {

        testCommand(Critter.WALL, "123", 123);
        testCommand(Critter.WALL, "r10", 10);
        testCommand(Critter.WALL, "+10", 15);
        testCommand(Critter.WALL, "-10", -5);
    ...
    public void testCommand(int a, String n, int nextLine) {
        Command command = new IfWallCommand();
