...
public class IfHungryCommandTest extends TestCase {

    public void testExecuteCommand() {
        testCommand(Critter.HungerLevel.HUNGRY, "24445", 24445);
        testCommand(Critter.HungerLevel.HUNGRY, "r10", 10);
        testCommand(Critter.HungerLevel.HUNGRY, "+10", 15);
        testCommand(Critter.HungerLevel.HUNGRY, "-10", -5);
    ...
    public void testCommand(Critter.HungerLevel a, String n, int nextLine) {
        Command command = new IfHungryCommand();
